...
module GameweekFixtures =
  ...
  let buildShareGameweekStringTitle (gwfs: GameweekFixturesViewModel) =
  ...
  let buildShareGameweekStringText (gwfs: GameweekFixturesViewModel) =
    let modifierToText =
      function
  ...
  let update api player msg model : Model * Cmd<Msg> =
    (match msg with
     ...
     | ShareGameweek gwfs ->
       ...
       let shareData = Sharing.ShareData(buildShareGameweekStringTitle gwfs, buildShareGameweekStringText gwfs, "")
